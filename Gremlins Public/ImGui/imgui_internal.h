...
namespace ImGui
{
    ...
    IMGUI_API bool          BeginChildEx(const char* name, ImGuiID id, const ImVec2& size_arg, bool border, ImGuiWindowFlags flags, int i);
    ...
    IMGUI_API void          RenderComboText(ImVec2 pos, ImColor col, const char* text, const char* text_end = NULL, bool hide_text_after_hash = true);
    ...
    bool subdown(const char* label, bool selected);
