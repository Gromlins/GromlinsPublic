...
#pragma section(".Ohcrackx1", execute, read, write) //Write so we can erase encryption func
#pragma comment(linker,"/SECTION:.Ohcrackx1,ERW")
#pragma code_seg(push, ".Ohcrackx1")
...
void protect::initialize() {
	...
	encrypt_section(get_section_by_name(es(".text")));
